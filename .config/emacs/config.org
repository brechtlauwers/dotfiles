...
#+begin_src emacs-lisp
  ...
  (defun my-mood-line-pdf-pages ()
    "Displays the current page and total pages in the mood-line for PDF files."
    (when (derived-mode-p 'pdf-view-mode)
      (format " %d/%d "
              (pdf-view-current-page)
              (pdf-cache-number-of-pages))))

  (defun my-mood-line-word-count ()
    "Display total word count in text-based modes."
    (when (derived-mode-p 'text-mode 'markdown-mode 'org-mode)
  ...
  (setq mood-line-format
      (mood-line-defformat
        :left  (((mood-line-segment-buffer-status) . " ")
                ...
                ((my-mood-line-pdf-pages) . " ")
  	      ((my-mood-line-word-count) . " "))
...
#+begin_src emacs-lisp
  ...
  ;; Get all cross-references and citations correct when exporting
